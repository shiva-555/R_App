...
router.post('/candidate', authorizeRoles('Recruiter', 'Admin'),
//  validate({body: candidateSchema}), 
 appController.createCandidate);
router.get('/candidate/:candidateId', authorizeRoles('Recruiter', 'Admin'), appController.getCandidate)
router.put('/candidate/:candidateId', authorizeRoles('Recruiter', 'Admin'), appController.updateCandidate);
